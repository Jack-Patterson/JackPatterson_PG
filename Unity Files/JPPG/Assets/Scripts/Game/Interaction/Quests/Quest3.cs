...
public class Quest3 : MonoBehaviour, IQuestable
{
    ...
    private void Start()
    {
        ...
        setQuestName("Store an item.");
        setQuestDescription("Allow the villager to store an item once their inventory is filled.");
    }
